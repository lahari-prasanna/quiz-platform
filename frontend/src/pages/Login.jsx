      ...
      <div className="right-panel">
        <div className="form-wrap">
          ...
          <p className="register-link">
            ...
            <Link to="/register" className="register-link-a">Create one free</Link>
          </p>
        </div>
      </div>
    </div>
...
const css = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .brand-tagline { font-size: 15px; color: rgba(255,255,255,0.75); margin-bottom: 48px; line-height: 1.5; }
